...
export abstract class AInMemoryStore {
    ...
    protected upsert(object: unknown, key: string): void {
    ...
    protected find<T>(keys: string[], values: Value[]): T[] {
    ...
    protected delete(key: string, value: string | boolean | number): void {
